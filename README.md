...
Впрочем, программа ещё может измениться.
...
Если не озвучено иное, то каждое задание рассчитано на две недели.
...
Последующая информация преимущественно предназначена для Windows, так как линуксов бывает много разных.
Если у вас конкретно что-то не получается под Linux, пишите в чате, лучше разбираться с каждой ситуацией отдельно.
